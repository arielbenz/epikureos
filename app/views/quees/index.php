	...
	<section id="barra-quees" class="barra-content">
		<div id="barra">
			<div id="barra-titulo">
				<h2><b class="font-bold">¿QUÉ ES?</b></h2>
			</div>
		</div>
	</section>
	...
	<section id="content-quees">
		...
		<p>Así mismo, también, queremos que siempre tengas disponible y a mano las últimas novedades, "la posta". Ya que entendemos lo importante que es para vos pasar un buen momento, en un buen lugar y del tiempo que podes ganar a través de nuestra iniciativa.</p>
		 
		<p>Otro de los objetivos, no menos importante es impulsar eventos y actividades relacionadas con el objetivo de posicionar a la ciudad y la región en el mundo gastronómico.</p>
